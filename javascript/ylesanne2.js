...
// Loome muutujad ja määrame neile väärtused
var number = 4.2;  // Tüüp: number
var tekst1 = 'Will Code 4 food';  // Tüüp: string
var tekst2 = "123";  // Tüüp: string
var loogikaVäärtus = true;  // Tüüp: boolean
var massiiv = [1, 2, 3];  // Tüüp: array
var valeVäärtus = false;  // Tüüp: boolean
var tekst3 = 'true';  // Tüüp: string
var määratlemata;  // Tüüp: undefined

// Väljastame muutujate väärtused konsooli
console.log(typeof(number));
console.log(typeof(tekst1));
console.log(typeof(tekst2));
console.log(typeof(loogikaVäärtus));
console.log(typeof(massiiv));
console.log(typeof(valeVäärtus));
console.log(typeof(tekst3));
console.log(typeof(määratlemata));
...
var sekundid = 59;
var päevaosa = "PM";
var kellaaeg = `${tunnid}:${minutid}:${sekundid}${päevaosa}`;
console.log(kellaaeg);

// Tsitaat lause sees
var tsitaat = "Elu on nagu jalgrattasõit, et hoida tasakaalu, pead liikuma.";
var autor = "Albert Einstein";
var tsitaatLause = `"${tsitaat}" - ${autor}`;
console.log(tsitaatLause);
...
var komaAsukoht = täisnimi.indexOf(",");
var perenimiOsa = täisnimi.substring(0, komaAsukoht);
perenimiOsa = perenimiOsa.toUpperCase();
console.log(perenimiOsa);
console.log(`Perenime pikkus: ${perenimiOsa.length}`);
...
console.log(`IP-aadress: ${ipAadress} ja email: ${email}`);
